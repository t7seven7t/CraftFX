...
public class NMSAdapter implements NMSInterface {
    ...
    public List<AttributeModifier> getAttributeModifiers(ItemStack item) {
        ...
        Multimap<String, net.minecraft.server.v1_8_R2.AttributeModifier> multimap = CraftItemStack
                .asNMSCopy(item).B();
        for (String attributeName : multimap.keySet()) {
            for (net.minecraft.server.v1_8_R2.AttributeModifier m : multimap.get(attributeName)) {
